...
- `fastapi` must be constrained to `>= 0.136.1,<0.136.3` to mitigate MAL-2026-4750 (a malicious dependency confusion attack in 0.136.3), and `starlette` is upgraded to `>= 1.0.1` to fix vulnerabilities such as CVE-2025-54121, CVE-2025-62727, and PYSEC-2026-161.
