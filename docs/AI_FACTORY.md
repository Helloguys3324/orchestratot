...
- `GH_PAT`: A GitHub Personal Access Token with repository permissions for validation auto-merge. **Required:** This token is strictly required for the YOLO Auto-Merge step in `ai-factory-validate.yml`.
